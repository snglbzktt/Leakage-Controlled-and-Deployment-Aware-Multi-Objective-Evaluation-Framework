...
def input_space_requires_scaling(
    value: str,
) -> bool:
...
def main() -> None:
    ...
    print(
        "Parser policy   : exact locked-token equality"
    )
    ...
    for run_number, row in enumerate(
        ...
        run_manifest = {
            ...
            "prior_invalid_run_archive": str(
                INVALID_RUN_ARCHIVE
            ),
            "prior_invalidation_report": str(
                INVALIDATION_REPORT
            ),
