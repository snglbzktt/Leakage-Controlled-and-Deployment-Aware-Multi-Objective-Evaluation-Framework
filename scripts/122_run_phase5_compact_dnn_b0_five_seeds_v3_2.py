...
for output_path in (
    ...
    if output_path.exists():
        raise FileExistsError(
            "Compact-DNN B0 aggregate artifact already exists; "
...
tinyml_b0_lock = read_json(TINYML_B0_LOCK)
...
entry_checks = {
    ...
    "tinyml_B0_locked_before_compact_training": (
        tinyml_b0_lock.get("status") == "locked"
    ...
    "matrix_has_five_compact_B0_rows": (
...
if failed_entry_checks:
    raise RuntimeError(
        "Compact-DNN B0 entry gate failed: "
...
if failed_shape_checks:
    raise RuntimeError(
        "Compact-DNN B0 cache checks failed: "
...
if (
    ...
    raise RuntimeError(
        "Compact-DNN B0 preprocessing artifact shape mismatch."
    )
...
print("=" * 92)
print("PHASE 5 COMPACT-DNN B0 FIVE-SEED TRAINING")
print("=" * 92)
...
for run_index, seed in enumerate(SEEDS, start=1):
    run_id = f"compact_dnn__b0__seed_{seed}"
...
print()
print("=" * 92)
print("PHASE 5 COMPACT-DNN B0 FIVE-SEED SUMMARY")
print("=" * 92)
...
print("PHASE 5 COMPACT-DNN B0 FIVE-SEED TRAINING COMPLETED")
