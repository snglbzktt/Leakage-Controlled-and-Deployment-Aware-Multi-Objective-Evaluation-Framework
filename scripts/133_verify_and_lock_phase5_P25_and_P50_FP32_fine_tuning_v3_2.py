...
OUTPUT_VERIFIED_RUNS_CSV = (
    AUDIT
    / "phase5_pruning_FP32_FT_verified_runs_v3_2.csv"
)

OUTPUT_VERIFICATION = (
    AUDIT
    / "phase5_pruning_FP32_FT_verification_v3_2.json"
)
...
OUTPUT_LOCK_MANIFEST = (
    AUDIT
    / "phase5_pruning_FP32_FT_lock_manifest_v3_2.json"
)
...
model_module = load_module(
    MODEL_SOURCE,
    "phase5_pruning_ft_verify_models",
)

engine_module = load_module(
    PRUNING_ENGINE_PATH,
    "phase5_pruning_ft_verify_engine",
)
...
print("=" * 92)
print("PHASE 5 P25 AND P50 FP32 FINE-TUNING INDEPENDENT VERIFICATION")
print("=" * 92)
print(
    "Runs                            : 20"
)
...
for index, key in enumerate(
    ...
    checks = {
        ...
        "complexity_matches": (
            ...
            and engine_module.linear_macs_per_sample(
                model
            )
            == int(
                metrics[
    ...
    print(
        f"[{index}/20] "
        f"{architecture} seed={seed} "
        f"{CANONICAL_REPORT_NAME[variant]} | "
        "checkpoint=loaded | "
        "validation=exact | "
...
global_checks = {
    ...
    "no_fragility_after_fine_tuning": (
        all(
            row[
                "fragility_gate_triggered"
            ]
...
verification = {
    ...
    "ready_for_remaining_phase5_compression_variants": True,
    "all_checks_passed": True,
}
...
print()
print("=" * 92)
print("PHASE 5 P25 AND P50 FP32 FINE-TUNING VERIFICATION SUMMARY")
print("=" * 92)
print(
...
print(
    "Fragility after fine-tuning     : False"
)
print(
    "FP32 fine-tuning status         : LOCKED"
)
print(
    "Ready for remaining variants    : True"
)
print(
    "Verification report             : "
...
print(
    "PHASE 5 P25 AND P50 FP32 FINE-TUNING VERIFIED AND LOCKED"
)
